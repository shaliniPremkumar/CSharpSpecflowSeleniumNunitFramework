...
{
    public class UnregisteredVehiclePermitPage
    {

        public IWebDriver Driver;

        public UnregisteredVehiclePermitPage(IWebDriver driver) => Driver = driver;

        /*
        * Setting the Vehicle Type
        * -----------------------------------------------------------------------------------
        */
        public UnregisteredVehiclePermitPage SelectVehicleType(string VehicleType)
        {
        ...
        * -----------------------------------------------------------------------------------
        */
        public UnregisteredVehiclePermitPage SelectSubTypeOrCapacity(string SubTypeOrCapacity)
        {
        ...
        * -----------------------------------------------------------------------------------
        */
        public UnregisteredVehiclePermitPage SetAddress(string Address)
        {
        ...
        * -----------------------------------------------------------------------------------
        */
        public UnregisteredVehiclePermitPage SetPermitStartDate(string PermitStartDate)
        {
        ...
        * -----------------------------------------------------------------------------------
        */
        public UnregisteredVehiclePermitPage SelectPermitDuration(String PermitDurationInDays)
        {
        ...
        * -----------------------------------------------------------------------------------
        */
        public UnregisteredVehiclePermitPage ClickCalculate()
        {
